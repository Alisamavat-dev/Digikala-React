      ...
      <footer className="bg-gray-100 hidden md:block">
        <div className="max-w-[1500px] mx-auto">
          <div className="flex justify-start">
            <div className="p-5">
              <img src={data?.[0]?.logo} className="w-52" alt="logo" />
            </div>
          </div>
          ...
          <div className="max-w-[1500px] mx-auto">
            <div className="flex justify-start gap-5">
              <p className="text-gray-500 text-sm">
                {data?.[0]?.phone} تلفن پشتیبانی
              </p>
              <hr className="text-gray-500" />
              <p className="text-gray-500 text-sm">{data?.[0]?.phone}</p>
              <hr className="text-gray-500" />
              <p className="text-gray-500 text-sm">
            ...
            <div className="grid grid-cols-4 w-full max-w-[1700px] mx-auto">
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <Link to={data?.[0]?.link} className="text-gray-600">
                      اتاق خبر دیجی کالا
                    </Link>
                  </li>
                  <li>
